...
| :------------------ | ---------- | -------------- | ------------ | :---------------- | --------------------- | ------------------- | ------------------------------------------------------------------------------------------------ |
| Can be instantiated | Yes        | Unknown status | No           | Forbidden         | Allowed               | none                | [dataset.schema.json](../../../schema/dataset/latest/dataset.schema.json "open original schema") |
...
| [physicalSampleAvailability](#physicalSampleAvailability) | Merged   | Required | cannot be null | [HDR UK Dataset](dataset-properties-the-physicalsampleavailability-schema.md "\#/properties/physicalSampleAvailability#/properties/physicalSampleAvailability") |
...
-   is required
-   Type: merged type ([The physicalSampleAvailability schema](dataset-properties-the-physicalsampleavailability-schema.md))
-   cannot be null
...
-   is required
-   Type: merged type ([The keywords schema](dataset-properties-the-keywords-schema.md))
-   cannot be null
...
-   [Untitled undefined type in HDR UK Dataset](dataset-properties-the-controlledvocabulary-schema-anyof-0.md "check type definition")
...
## Definitions group numericRange

Reference this group by using

```json
{"$ref":"https://raw.githubusercontent.com/HDRUK/schemata/master/schema/dataset/dataset.schema.json#/definitions/numericRange"}
```
...
-   Type: `string`
-   cannot be null
-   defined in: [HDR UK Dataset](dataset-definitions-numericrange.md "https&#x3A;//raw.githubusercontent.com/HDRUK/schemata/master/schema/dataset/dataset.schema.json#/definitions/numericRange")
...
## Definitions group conformsTo

Reference this group by using

```json
{"$ref":"https://raw.githubusercontent.com/HDRUK/schemata/master/schema/dataset/dataset.schema.json#/definitions/conformsTo"}
```
...
-   Type: `string`
-   cannot be null
-   defined in: [HDR UK Dataset](dataset-definitions-conformsto.md "https&#x3A;//raw.githubusercontent.com/HDRUK/schemata/master/schema/dataset/dataset.schema.json#/definitions/conformsTo")
